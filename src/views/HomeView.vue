            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="space-y-4">
                    ...
                    <div v-for="doc in featuredDocs" :key="doc.id"
                        class="bg-white p-5 rounded-xl shadow-sm border border-gray-200 hover:shadow-lg hover:border-indigo-300 transition-all duration-300">
                ...
                <div class="text-center mt-8">
                    <RouterLink to="/tra-cuu" class="text-blue-600 font-medium hover:underline cursor-pointer">
                        Xem tất cả văn bản
                    </RouterLink>
                </div>
            </div>
